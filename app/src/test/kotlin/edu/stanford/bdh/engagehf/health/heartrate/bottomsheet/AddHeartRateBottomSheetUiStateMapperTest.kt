...
class AddHeartRateBottomSheetUiStateMapperTest {

    private lateinit var dateTimeFormatter: DateTimeFormatter
    private lateinit var uiStateMapper: AddHeartRateBottomSheetUiStateMapper

    @Before
    fun setup() {
        dateTimeFormatter = DateTimeFormatter(DateFormatter())
        uiStateMapper = AddHeartRateBottomSheetUiStateMapper(dateTimeFormatter)
    }

package edu.stanford.spezi.modules.onboarding.sequential.components
 ...
 * @sample edu.stanford.spezi.modules.onboarding.sequential.SequentialOnboardingScreen
 */
@Composable
...
fun OnboardingViewPagePreview() {
    OnboardingViewPage(
        ...
        iconId = edu.stanford.spezi.modules.design.R.drawable.ic_groups,
    )
}
